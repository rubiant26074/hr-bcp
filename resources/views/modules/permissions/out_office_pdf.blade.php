...
<body>
  ...
  <table class="table header-table">
    <tr>
      ...
      <td class="header-right">
        <div class="small">Nomor: IZIN-KELUAR/{{ (int) $item->id }}/{{ strtoupper($company->company_code ?? '') }}/{{ date('Y') }}</div>
        <div class="small">Tanggal Cetak: {{ date('d/m/Y') }}</div>
      </td>
    </tr>
  </table>

  <div class="title">SURAT IZIN KELUAR KANTOR</div>
  <div class="subtitle">Permohonan Izin Keluar</div>
  ...
  <div class="section box">
    <table class="table">
      ...
      <tr>
        ...
        <td colspan="3">{{ $item->destination ?? '-' }}</td>
      </tr>
      <tr>
  ...
  <div class="section">
    <div class="small muted">Dengan ini menyatakan pengajuan izin keluar kantor sesuai data di atas.</div>
  </div>
