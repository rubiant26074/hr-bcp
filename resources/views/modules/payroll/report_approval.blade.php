...
@section('content')
<h4 class="mb-3">Approval Payroll Report</h4>
...
<div class="card shadow-sm mb-3">
  <div class="card-body">
    <div class="d-flex flex-wrap justify-content-between gap-2 align-items-center">
      ...
      <div>
        <a class="btn btn-outline-secondary btn-sm" href="{{ route('payroll.report') }}">Kembali ke Payroll Report</a>
      </div>
    </div>
  </div>
</div>
            ...
            <tr>
              ...
              <td class="text-end">
                @if ($canApprove)
                  ...
                  <form method="post" class="d-inline" onsubmit="return confirm('Tolak approval payroll report?');">
                    @csrf
                    <input type="hidden" name="id" value="{{ $row->id }}">
